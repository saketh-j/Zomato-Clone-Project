  ...
  return (
    <div className='explore-card cursor'>
          ...
          <div className='res-row'>
           ...
           {rating && (<div className='res-rating absolute-center'>{rating}<AiFillStar className='absolute-center'/></div>)}
          </div>
          <div className='res-row'>
             {cuisines.length && (
        ...
        {bottomContainer.length > 0 &&( <div>
            ...
            <img src={bottomContainer[0]?.image?.url} style={{height:"18px"}} alt={bottomContainer[0]?.text}/>
